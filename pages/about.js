...
export default function About() {
    ...
    <div className="background">
        ...
        <div><a href="#top" class="idTop">AUGŠUP</a></div>
        ...
        <div className="listiki">
                ...
                <div className="info_13"><p></p>Vaksācija</div>
...
ēteriskās eļļas vai ēterisko eļļu maisījumi.
       ...
       <div className="lenta6"></div>
               ...
               <div className="info_5"><p>Šokolādes maska</p> </div>
                <div className="rectangle4">
                   
                   <div className="info_5_1"><p>Šokolāde ir ne tikai populārs kārums, bet arī efektīgs 
līdzeklis veselības uzlabošanai un ādas attīrīšanai. Produkts sniedz 
 uz ādas audiem vitamīnus, minerālu elementus un bioaktīvās
 vielas.
    </p></div>
